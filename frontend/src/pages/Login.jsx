...
export default function Login() {
  ...
  return (
    <div style={styles.pageWrapper} className="login-page-container">
      ...
      {/* 📝 RIGHT PANEL (Professional White Design) */}
      ...
      {showReset && (
        <div style={styles.modalOverlay}>
          <div style={styles.modalCard}>
            <h3 style={{color: '#0f172a', marginBottom: '20px', fontWeight: '800'}}>Reset Password</h3>
      ...
      {/* 📱 MOBILE VIEW: Clean White & Vertically Centered */}
      <style>{`
        .login-spinner { width: 18px; height: 18px; border: 2px solid rgba(255,255,255,0.3); border-top: 2px solid #fff; border-radius: 50%; animation: spin-login 0.8s linear infinite; }
        @keyframes spin-login { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }

        @media (max-width: 850px) {
          .login-page-container { background: #ffffff !important; }
          ...
          .login-field { background: #ffffff !important; color: #0f172a !important; border: 1.5px solid #e2e8f0 !important; }
        }
      `}</style>
    </div>
  );
...
const styles = {
  pageWrapper: { height: "100vh", display: "flex", overflow: "hidden", fontFamily: "'Inter', sans-serif", background: "#f8fafc" },
  ...
  rightPanel: { flex: 1, background: '#ffffff', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '40px' },
  ...
  formTitle: { fontSize: '28px', fontWeight: '900', color: '#0f172a', margin: '15px 0 30px 0' },
  label: { width: '100%', textAlign: 'left', display: 'block', fontSize: '12px', fontWeight: '800', color: '#64748b', marginBottom: '8px', textTransform: 'uppercase' },
  input: { width: "100%", padding: "14px 16px", marginBottom: "20px", borderRadius: "10px", border: "1.5px solid #e2e8f0", background: "#fff", color: "#0f172a", fontSize: '16px', outline: 'none' },
  passwordContainer: { position: "relative", width: "100%", marginBottom: "30px" },
  passwordInput: { width: "100%", padding: "14px 16px", borderRadius: "10px", border: "1.5px solid #e2e8f0", background: "#fff", color: "#0f172a", fontSize: '16px', outline: 'none' },
  ...
  modalCard: { background: "#fff", padding: "40px", borderRadius: "24px", width: "400px", boxShadow: '0 20px 25px -5px rgba(0,0,0,0.1)' }
};